...
SuperBO supbo;
    ...
    void editbutton(ActionEvent event) {
        suppliersDTO customer=new suppliersDTO(sid.getValue(), name.getText(), address.getText(), email.getText(),Integer.parseInt(tel.getText()), Double.parseDouble(amount.getText()));
        supbo.EDIT(customer);
